...
parser.add_argument(
    "-q", "--quiet", dest="quiet", action="store_true", help="suppress output"
)
parser.add_argument(
    "-v", "--verbose", dest="verbose", action="store_true", help="Show maximum output"
)
parser.add_argument(
    "-V", "--version", dest="version", action="store_true", help="Output version info"
)
parser.add_argument(
    "-d",
    "--do-not-load",
...
def main() -> None:
    ...
    async def on_ready():
        ...
        print(
            "This is a long line that black shoulod automatically format... I'm trying to make this as long as possible........... How's your day? OK I think it's enough now"
        )
    ...
    try:
        ...
        raise KeyError(
            "Ouch! It seems as if you passed an invalid token! Remember to store it in the 'TOKEN' variable of your .env file"
        )
    t1.join()
